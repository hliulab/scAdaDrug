...
source_data = pd.read_csv('datasets/data_sc/Source_exprs_resp_z.' + drug + '_tp4k.tsv', sep='\t')
target_data = pd.read_csv('datasets/data_sc/Target_expr_resp_z.' + drug + '_tp4k.tsv', sep='\t')
...
# # data_precily
# source_x = source_data.iloc[:, 2:].values
# source_y = source_data.iloc[:, 1].values
...
# # data_precily
# target_x = target_data.iloc[:, 3:].values
# target_y = target_data.iloc[:, 2].values
